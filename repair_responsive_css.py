...
if marker in content:
    base_css = content.split(marker)[0]
else:
    # Fallback
    marker2 = "/* ========================================="
    if marker2 in content:
        base_css = content.split(marker2)[0]
    else:
        base_css = content
...
@media (max-width: 768px) {
    ...
    .mural-left { left: -10px; transform: translateY(-50%); }
    .mural-right { right: -10px; transform: translateY(-50%); }
...
print("Responsive CSS repaired successfully.")
